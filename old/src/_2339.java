...
//	���õ� �Ҽ����� ��ġ���� �ڸ���.
//	public static boolean select(int sx, int sy, int ex, int ey, Inpur inpur, int dir) {
//		
//
//		int num1;
//		int num2;
...
//			num2 = divide(inpur.x+1, sy, ex, ey, dir);
//
//		}else {
//			num1 = divide(sx, sy, ex, inpur.y-1, dir);
//			num2 =divide(sx, inpur.y+1, ex, ey, dir);
//		}
//		
